drop table if exists api_svc.raid cascade;
...
create table api_svc.raid (
  ...
  service_point_id bigint references api_svc.service_point                             not null,
...
comment on column api_svc.raid.url is
